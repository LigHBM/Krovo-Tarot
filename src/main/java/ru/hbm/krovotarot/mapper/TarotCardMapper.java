...
public interface TarotCardMapper {
    ...
    @Mapping(target = "questionsMeaning", source = "tarotCard.questionsMeaning.description")
    ...
    @Mapping(target = "questionsMeaningReverse", source = "tarotCard.questionsMeaning.reverseDescription")
